...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:Admin')->group(function () {
        ...
        // Payroll
        Route::post('admin/payroll/bulk-generate', [\App\Http\Controllers\PayrollController::class, 'bulkGenerate'])->name('admin.payroll.bulk-generate');
    ...
    Route::get('payslips/{payslip}/download', [\App\Http\Controllers\PayrollController::class, 'downloadPayslip'])->name('payslips.download');
