<x-guest-layout>
    ...
    <x-flash-messages
        successClass="mb-6 p-4 bg-green-50 border border-green-200 text-green-800 rounded-lg text-sm text-center"
        errorClass="mb-6 p-4 bg-red-50 border border-red-200 text-red-800 rounded-lg text-sm text-center"
    />
