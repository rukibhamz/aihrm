<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 flex justify-end gap-3">
            ...
            <a href="{{ route('leaves.edit', $leaf) }}" class="px-6 py-2 bg-primary text-white rounded-lg text-sm font-bold hover:bg-black transition-colors shadow-lg shadow-neutral-200">
                Edit Request
            </a>
        </div>
        @endif
