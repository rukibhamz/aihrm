<x-app-layout>
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-900">Add New Asset</h2>
    </div>

<div class="card max-w-4xl mx-auto">
    <form action="{{ route('admin.assets.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="col-span-1">
                ...
                <p class="text-xs text-gray-500 mt-1">Select an employee to assign this asset immediately.</p>
            </div>
