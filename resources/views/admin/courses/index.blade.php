<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-flash-messages
                successClass="mb-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative"
                errorClass="mb-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
            />
                            ...
                            @foreach ($courses as $course)
                                <tr>
                                        ...
                                        <div class="flex items-center">
                                            @if($course->thumbnail)
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-full object-cover" src="{{ asset('storage/' . $course->thumbnail) }}" alt="">
                                                </div>
                                            @endif
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.courses.edit', $course) }}" class="text-primary hover:text-indigo-900 mr-4">Edit</a>
