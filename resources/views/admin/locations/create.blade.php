        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-xl shadow-sm border border-neutral-100 p-8">
                <form action="{{ route('admin.locations.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition text-sm" placeholder="e.g. Headquarters, Lagos Office">
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-neutral-700">Latitude</label>
                            <input type="number" step="any" name="latitude" id="lat" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition text-sm font-mono" placeholder="6.5244">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-neutral-700">Longitude</label>
                            <input type="number" step="any" name="longitude" id="lng" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition text-sm font-mono" placeholder="3.3792">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="number" name="radius_meters" value="100" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition text-sm" placeholder="100">
            ...
            <div class="space-y-6">
                <div class="bg-indigo-600 rounded-xl p-8 text-white shadow-lg">
                    ...
                    <button type="button" onclick="getCurrentLocation()" class="w-full py-3 bg-white text-indigo-600 font-bold rounded-lg hover:bg-neutral-50 transition shadow-sm flex items-center justify-center gap-2">
