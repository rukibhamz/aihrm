    ...
    <div class="max-w-2xl bg-white rounded-xl shadow-sm border border-neutral-100 p-8">
        <form action="{{ route('admin.shifts.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-primary transition text-sm" placeholder="e.g. Morning Shift">
            </div>

            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-neutral-700">Start Time</label>
                    <input type="time" name="start_time" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-primary transition text-sm">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-neutral-700">End Time</label>
                    <input type="time" name="end_time" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-primary transition text-sm">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input type="number" name="grace_period_minutes" value="15" required class="w-full px-4 py-2.5 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-primary transition text-sm" placeholder="15">
