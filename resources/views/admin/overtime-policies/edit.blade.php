    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-neutral-900">Edit Overtime Policy</h1>
            </div>
            <p class="text-sm text-neutral-500 ml-8">Update definition for how overtime hours are converted to pay.</p>
        </div>
    </div>

    <div class="max-w-3xl">
        <div class="card p-6">
            <form action="{{ route('admin.overtime-policies.update', $overtimePolicy) }}" method="POST">
                @csrf
                @method('PUT')
                
                <div class="mb-6">
                    <x-form.label for="name" value="Policy Name" required />
                    <x-form.input id="name" name="name" type="text" value="{{ old('name', $overtimePolicy->name) }}" required placeholder="e.g. Standard Overtime Rule" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <x-form.input id="standard_daily_hours" name="standard_daily_hours" type="number" step="0.5" min="0" max="24" value="{{ old('standard_daily_hours', $overtimePolicy->standard_daily_hours) }}" required />
                ...
                <div class="border-t border-neutral-200 pt-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <x-form.input id="weekday_multiplier" name="weekday_multiplier" type="number" step="0.1" min="1" value="{{ old('weekday_multiplier', floatval($overtimePolicy->weekday_multiplier)) }}" required />
                        ...
                        <div>
                            ...
                            <x-form.input id="weekend_multiplier" name="weekend_multiplier" type="number" step="0.1" min="1" value="{{ old('weekend_multiplier', floatval($overtimePolicy->weekend_multiplier)) }}" required />
                        ...
                        <div>
                            ...
                            <x-form.input id="holiday_multiplier" name="holiday_multiplier" type="number" step="0.1" min="1" value="{{ old('holiday_multiplier', floatval($overtimePolicy->holiday_multiplier)) }}" required />
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_active" class="rounded border-neutral-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" {{ old('is_active', $overtimePolicy->is_active) ? 'checked' : '' }}>
