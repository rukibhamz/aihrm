...
<head>
    ...
    <x-branding-meta title="Application Submitted" />
...
<body class="bg-neutral-50 min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full text-center">
        <div class="bg-white rounded-xl shadow-sm border border-neutral-200 p-8">
            ...
            <h1 class="text-2xl font-bold mb-2">Application Submitted!</h1>
            <p class="text-neutral-600 mb-6">
                Thank you for applying. Our AI is analyzing your resume and will rank your application based on job requirements. We'll contact you soon!
            </p>
